...
def main():
    ...
    #obstacle_points.append([(300, 150), (700, 150), (700, 800), (600, 800), (600, 300), (400, 300), (400, 800), (300, 800)])
    for i in range(len(obstacle_points)):
    ...
    for i in range(numNodes):
        ...
        if noCollision(random_point.getCoord(), near_point.getCoord(), obstacle_points):
            plt.plot([new_point.getCoord()[0], near_point.getCoord()[0]], [new_point.getCoord()[1], near_point.getCoord()[1]], color='blue')
    ...
    for i in range(len(nodes)):
        tmpdist = calculateDistance(nodes[i].getCoord(), goal_point.getCoord())
        D.append(tmpdist)
